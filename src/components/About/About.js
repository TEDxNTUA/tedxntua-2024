...
export default function About({ fullname, photo }) {
  ...
  return (
    <div className="flex flex-col bg-neutral-50 rounded-md border-[3px] w-full sm:w-[90%] md:w-[80%] lg:w-full border-our-purple-100 lg:border-black hover:border-our-purple-100 mx-auto h-full">
      <div
        ...
        <div className="relative">
          <div className="flex flex-col rounded-sm justify-center items-center group">
            ...
            <div className="absolute inset-0 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity">
              <p className=" text-our-purple-100 bg-black bg-opacity-75 py-2 px-3 md:px-4 lg:px-6 rounded-lg font-semibold text-center text-base lg:text-2xl lg:h-fit 2xl:text-4xl">
                Learn More
              </p>
            </div>
          </div>
