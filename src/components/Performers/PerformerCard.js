      ...
      >
        <div className="relative">
          <div className="flex flex-col rounded-sm justify-center items-center group">
            <img
              className="w-full md:h-[20vh] xl:h-[50vh] object-center object-cover group-hover:grayscale group-hover:blur-[2px]"
              src={photo}
              alt={fullname}
            />
            <div className="absolute inset-0 flex justify-center items-center pt-[20vh] opacity-0 group-hover:opacity-100 transition-opacity">
              <p className="text-white bg-black bg-opacity-75 py-2 px-3 md:px-4 lg:px-6 rounded-lg font-semibold text-center text-base lg:text-2xl lg:h-fit 2xl:text-4xl">
                Learn More
              </p>
            </div>
          </div>
