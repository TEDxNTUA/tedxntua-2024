export const SPEAKERSLIST = [
  ...
  },
  {
    ...
    bio: "Ονομάζομαι Φώτης Φλώρος, είμαι 22 ετών και σπουδάζω Θεωρία και Ιστορία της Τέχνης στην Ανωτάτη Σχολή Καλών Τεχνών. Παράλληλα, είμαι ο δημιουργός του project επιστήμης κοινού The Dandy, μίας σελίδας που σκοπό έχει να φέρει τον κόσμο πιο κοντά με την τέχνη μέσα από τα social media. Μέσα από ενδιαφέρουσες και περίεργες ιστορίες, προσπαθώ να κάνω την επιστήμη μου πιο προσιτή στο κοινό και να αποδείξω ότι η τέχνη είναι κάτι που ανήκει σε όλους. Αναζητώ τα πρόσωπα και τις ιστορίες πίσω από διάσημα έργα τέχνης και τα ξανασυστήνω στον κόσμο με μια νέα ματιά.",
    bio_en: "",
